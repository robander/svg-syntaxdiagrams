...
function syntaxdiagram_stretch(svgNode)
{
  ...
  //  Remove scaling in svg; let the embedding file do the work
  //  var scale = 1;
  ...
  //  svgNode.setAttribute("height", height / scale * syntaxdiagram_Constants.diagram_scale + syntaxdiagram_Constants.diagram_unit);
      svgNode.setAttribute("width", width / syntaxdiagram_Constants.diagram_scale + syntaxdiagram_Constants.diagram_unit);
      svgNode.setAttribute("height", height / syntaxdiagram_Constants.diagram_scale + syntaxdiagram_Constants.diagram_unit);
